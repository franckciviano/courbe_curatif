...
const selectClass =
  'w-full bg-white border border-slate-300 rounded-lg px-3 py-1.5 text-sm text-slate-800 ' +
...
export default function CurveCard({ curve, onChange, onRemove, onDuplicate }) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm transition-all duration-200">
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <button
          ...
          className="shrink-0 p-1.5 text-slate-400 hover:text-violet-600 hover:bg-violet-50 rounded-lg transition-all duration-200"
        >
        ...
        <button
          ...
          className="shrink-0 p-1.5 text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all duration-200"
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {isUnavailable && (
        <p className="mt-2 text-xs text-amber-600">Combinaison indisponible</p>
      )}
      ...
      <div className="mt-3 pt-3 border-t border-slate-200">
        ...
        {estimate && (
          <p className={`mt-1 text-[10px] ${estimate.over ? 'text-amber-600' : 'text-slate-400'}`}>
